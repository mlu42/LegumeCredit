 ...
 //       subjectInput.setText(getSubjectTime());
    ...
    */
    private void emailReportLegume() {
        ...
        bodyText += "This email generated by Manure and Legume Credit Calculator, an Android app by the University of Wisconsin-Madison's NPM program\n";
    ...
    private void emailReportManure() {
        ...
        bodyText +="\n\nApplication Rate: " + counterManureE + " " + unitManureE +
                "\n\nManure Credit: " + "Available N - " + creditN_E +
                "\n                           " + "Available P₂O₅ - " + creditP_E +
                "\n                           " + "Available K₂O - " + creditK_E +
                "\n                           " + "Available S - " + creditS_E + "\n\n";
